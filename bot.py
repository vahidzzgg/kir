...
api_id = 19943463 # آی پی آی آیدی بزارید
api_hash = "63b6a9dc5a1db8604a54303c0e16aed3" # آی پی آی هش بزارید
client = TelegramClient('zxxxx' , api_id , api_hash)
client.start()

AdminBot = 1073813546 # آیدی عددی اکانتی که میخاید ران کنید
main = '9876543210'
